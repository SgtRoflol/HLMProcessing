/* autogenerated by Processing revision 1293 on 2024-02-03 */
...
public void loadScene(String path, int index){
...
class Player{
    ...
    public void renderWeapons() {
        for (Weapon Waffe : Waffen) {
            Waffe.render();
            Waffe.setTarget(worldCamera.Pos.x + mouseX+PApplet.parseInt(random(-sway,sway)),worldCamera.Pos.y + mouseY+PApplet.parseInt(random(-sway,sway)));     
        }
    }
